...
an introduction how to use the mentioned standards and tools.
...
know much about the image, we won't go down this road. Instead, let's use a
...
\begin{exercise}
For the VO-pro: See where we mention SODA above ? Try it!
\end{exercise}
