...
for \key{RA} enter \entry{70}, for \key{Dec} enter \entry{25} and and give
...
between client software. One of these standards is Datalink. Some
services and clients can already consume datalink. Luckily, the GAVO
...
\entry{#preview}. 
If you scroll through these four entries, you notice, that  \entry{#auxiliary}, \entry{#this}, and
...
window selec at \key{Type:} \entry{FITS_Image} and next to it at
